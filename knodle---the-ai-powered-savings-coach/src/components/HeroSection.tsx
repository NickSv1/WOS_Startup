          ...
          {!joined ? (
            <form onSubmit={handleJoin} className="flex flex-col sm:flex-row items-stretch gap-2.5">
              ...
              <button
                ...
                type="submit"
                className="shrink-0 bg-[#000000] text-[#c1ff72] font-bold text-base px-6 py-3.5 sm:py-4 rounded-xl hover:bg-[#1a1a1a] active:scale-95 transition-all shadow-lg shadow-black/10 flex items-center justify-center gap-2 cursor-pointer"
              >
            ...
            <div className="flex items-center justify-center gap-2.5 bg-[#c1ff72]/25 border border-[#c1ff72] rounded-xl px-4 py-3.5 sm:py-4 text-sm font-semibold text-black">
              ...
              <span>You&apos;re in at #247 — confirmation sent to {email}.</span>
            </div>
          )}

          <div className="mt-3.5 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-sm">
            <span className="text-neutral-500 text-xs">No spam. Invites go out every Friday.</span>
            <a
              href="#afford-section"
